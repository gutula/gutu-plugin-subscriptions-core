...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/subscriptions-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-subscriptions-core:");
...
console.log("Documentation check passed for gutu-plugin-subscriptions-core.");
