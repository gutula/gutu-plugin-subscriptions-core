...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Subscriptions Control Room"),
    React.createElement("p", null, "Plan truth, recurring billing cycles, renewal posture, and subscription-side exceptions."),
    React.createElement(
      "p",
      null,
